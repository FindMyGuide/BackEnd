...
//
//    @Transactional
//    public TourHistoryManagerResponse reserveTourByTourist(String touristEmail, Long tourProductId, TourHistoryManagerGuideRequest tourHistoryManagerGuideRequest) {
//        Member tourist = findMemberByEmail(touristEmail);
//        TourHistoryManager existingTourHistoryManager = findTourHistoryManagerByTourProductId(tourProductId);
//
...
//        existingTourHistoryManager.setTourStartDate(tourHistoryManagerGuideRequest.getTourStartDate());
//        existingTourHistoryManager.setTourEndDate(tourHistoryManagerGuideRequest.getTourEndDate());
//
...
//        return !tourHistoryManagerRepository.findByMember_Idx(memberId).isEmpty();
//    }
//
//
...
//                new IllegalArgumentException("해당 상품에 대한 예약 내역이 없습니다."));
//    }
//
