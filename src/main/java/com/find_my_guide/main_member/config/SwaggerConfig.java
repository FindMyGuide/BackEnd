...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.find_my_guide")) // Controller가 들어있는 패키지. 이 경로의 하위에 있는 api만 표시됨.
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("SpringBoot Rest API Documentation for FindMyGuide")
                .description("findMyGuide Api")
                .version("0.1")
                .build();
    }
}